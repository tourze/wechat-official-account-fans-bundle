...
/**
 * 拉黑用户
 * @see https://developers.weixin.qq.com/doc/offiaccount/User_Management/Blacklisting_a_user.html#%E6%8B%89%E9%BB%91%E7%94%A8%E6%88%B7
 */
class BatchBlacklistRequest extends WithAccountRequest
{
    /**
     * @var string[]
     */
    #[Assert\NotBlank(message: '用户openid列表不能为空')]
    #[Assert\Count(min: 1, max: 20, minMessage: '至少需要1个用户', maxMessage: '最多只能同时拉黑20个用户')]
    ...
    {
        return 'https://api.weixin.qq.com/cgi-bin/tags/members/batchblacklist';
    }
