...
use Tourze\WechatOfficialAccountFansBundle\Request\Tag\BatchUntagUsersRequest;
use WechatOfficialAccountBundle\Entity\Account;

/**
 * @internal
 */
#[CoversClass(BatchUntagUsersRequest::class)]
final class BatchUntagUsersRequestTest extends RequestTestCase
{
    public function testGetRequestPath(): void
    {
        $request = new BatchUntagUsersRequest();

        $this->assertSame('https://api.weixin.qq.com/cgi-bin/tags/members/batchuntagging', $request->getRequestPath());
    }
