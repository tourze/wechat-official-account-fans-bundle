...
use Tourze\WechatOfficialAccountFansBundle\Request\User\BatchBlacklistRequest;
use WechatOfficialAccountBundle\Entity\Account;

/**
 * @internal
 */
#[CoversClass(BatchBlacklistRequest::class)]
final class BatchBlacklistRequestTest extends RequestTestCase
{
    public function testGetRequestPath(): void
    {
        $request = new BatchBlacklistRequest();

        $this->assertSame('https://api.weixin.qq.com/cgi-bin/tags/members/batchblacklist', $request->getRequestPath());
    }
