...
use Tourze\WechatOfficialAccountFansBundle\Request\User\BatchUnblacklistRequest;
use WechatOfficialAccountBundle\Entity\Account;

/**
 * @internal
 */
#[CoversClass(BatchUnblacklistRequest::class)]
final class BatchUnblacklistRequestTest extends RequestTestCase
{
    public function testGetRequestPath(): void
    {
        $request = new BatchUnblacklistRequest();

        $this->assertSame('https://api.weixin.qq.com/cgi-bin/tags/members/batchunblacklist', $request->getRequestPath());
    }
